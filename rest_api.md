...
请求参数：
  ...
  sign      	string 	用户签名值                                   
  asset     	string 	资产名称，如：BTC,ETH等，表示所有资产名称                
  business  	string 	业务名称，如：deposit或trade，表示所有业务名称           
...
请求参数：
  ...
  order_id	integer	要取消交易的id。参看order.put_market方法的返回结果。
